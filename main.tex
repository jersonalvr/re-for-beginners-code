...
\ifdefined\customwidth
\documentclass[oneside]{book}
\newcommand{\FigScale}{0.28}
\else
\ifdefined\ebook
...
\ifdefined\customwidth
\usepackage[paperwidth=\customwidth,paperheight=\customheight,margin=0.25in,headheight=11pt]{geometry}
\else
\ifdefined\ebook
...
\newcommand{\TITLE}{\RU{Reverse Engineering для начинающих}\EN{Reverse Engineering for Beginners}\ES{Ingeniería inversa para principiantes}\PTBRph{}\PLph{}}
\newcommand{\AUTHOR}{\RU{Денис Юричев}\EN{Dennis Yurichev}\ES{Denis Yurichev}\PTBRph{}\PLph{}}
...
\ifx\LITE\undefined
\shorttoc{\RU{Краткое оглавление}\EN{Abridged contents}\PTBRph{}\ES{Contenido abreviado}\PLph{}}{-1} % Only sections
\fi
\tableofcontents
\cleardoublepage
...
\clearpage
\phantomsection
\addcontentsline{toc}{chapter}{\RU{Глоссарий}\EN{Glossary}\PTBRph{}\ES{Glosario}\PLph{}}
\printglossaries
...
\clearpage
\phantomsection
\addcontentsline{toc}{chapter}{\RU{Библиография}\EN{Bibliography}\PTBRph{}\ES{Bibliografía}\PLph{}}
\printbibliography
