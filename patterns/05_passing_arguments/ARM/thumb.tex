...
\ES{La instrucción \TT{MLA} no está disponible en modo Thumb, por lo que el compilador genera el código realizando estas dos operaciones (multiplicación y adición) por separado.}
...
\ES{Primero, la instrucción \TT{MULS} multiplica \Reg{0} por \Reg{1}, dejando el resultado en el registro \Reg{0}.}
...
\ES{La segunda instrucción (\TT{ADDS}) suma el resultado y \Reg{2}, dejando el resultado en el registro \Reg{0}.}
