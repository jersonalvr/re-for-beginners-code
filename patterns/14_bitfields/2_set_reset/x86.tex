...
\EN{The 10th bit was cleared (or, in other words, all bits were left except the 10th) and the final value now is}\ES{El 10º bit fue limpiado (o, en otras palabras, todos los bits fueron dejados excepto el 10º) y el valor final ahora es}\PTBRph{}\PLph{} \\
