...
\EN{If you find these four constants used in the code in a row, it is very highly probable that this function is related to MD5.}\PTBRph{}\ES{Si encuentras estas cuatro constantes usadas en el código en fila, es muy altamente probable que esta función esté relacionada con MD5.}\PLph{} \\
\\
