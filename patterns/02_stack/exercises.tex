...
Where they come from if you compile it in MSVC with optimization (\Ox)?}
\ES{Si compilamos esta sección de código en MSVC y lo ejecutamos, se imprimen tres números. ¿De dónde vienen? ¿De dónde vienen si lo compila en MSVC con optimización (\Ox)?}
\RU{Почему в GCC ситуация совсем иная}\EN{Why is the situation completely different if we compile with GCC}\ES{¿Por qué la situación es completamente diferente si compilamos con GCC}?
