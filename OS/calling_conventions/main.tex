...
\EN{The method is ubiquitous in win32 standard libraries, but not in win64 (see below about win64).}\ES{Este método es ubicuo en las bibliotecas estándar de win32, pero no en win64 (ver más abajo sobre win64).}\PTBRph{}\PLph{} \\
\\
