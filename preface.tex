\section*{\RU{Предисловие}\EN{Preface}\PTBRph{}\ES{Prefacio}\PLph{}}
...
\ifx\LITE\undefined
\subsection*{\RU{Рассмотренные темы}\EN{Topics discussed in-depth}\PTBRph{}\ES{Temas tratados en profundidad}\PLph{}}

x86/x64, ARM/ARM64, MIPS, Java/JVM.

\subsection*{\RU{Затронутые темы}\EN{Topics touched upon}\PTBRph{}\ES{Temas mencionados}\PLph{}}
...
\subsection*{\RU{Об авторе}\EN{About the author}\PTBRph{}\ES{Sobre el autor}\PLph{}}
...
\subsection*{\RU{Благодарности}\EN{Thanks}\PTBRph{}\ES{Agradecimientos}\PLph{}}
...
\EN{Those who supporting me while I'm writing my book and other articles.}%
\RU{Те, кто поддерживал меня во время написании книги и других статей.}
...
\RU{Огромное спасибо!}\EN{Thanks a lot!}
...
\subsection*{\RU{О переводе на корейский язык}\EN{About the Korean translation}\PTBRph{}\ES{Sobre la traducción al coreano}\PLph{}}
