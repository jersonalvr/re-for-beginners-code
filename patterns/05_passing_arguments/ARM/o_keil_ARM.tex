...
\ES{Y aquí está la función \ttf compilada por el compilador Keil en modo de optimización completa} (\Othree).
...
\ES{La instrucción \MOV fue optimizada (u omitida) y ahora \TT{MLA} utiliza todos los registros de entrada y coloca el resultado directamente en \Reg{0}, exactamente donde la función llamadora lo leerá y utilizará.}
