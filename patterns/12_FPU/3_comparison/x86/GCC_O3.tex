...
(these are \JA, \JAE, \JB, \JBE, \JE/\JZ, \JNA, \JNAE, \JNB, \JNBE, \JNE/\JNZ) check only flags \CF and \ZF.}\ES{Es casi lo mismo excepto que se usa \JA después de \SAHF. De hecho, las instrucciones de salto condicional que verifican \q{mayor}, \q{menor} o \q{igual} para comparación de números sin signo (éstas son \JA, \JAE, \JB, \JBE, \JE\/\JZ, \JNA, \JNAE, \JNB, \JNBE, \JNE\/\JNZ) verifican solo las banderas \CF y \ZF.}\PTBRph{}\PLph{}\\
\\
