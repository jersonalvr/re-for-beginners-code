...
\PTBRph{}\ES{Es fácil de entender si imaginas el número 23 en el sistema numérico decimal. 23 se puede dividir fácilmente por 10 simplemente eliminando el último dígito (3---resto de la división). 2 queda después de la operación como \gls{quotient}.}\PLph{}\\
\\
