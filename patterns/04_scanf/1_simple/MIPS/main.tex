...
\ES{Se asigna un lugar en la pila local para la variable $x$, al cual se accederá como $\$sp+24$.}
...
\ES{Su dirección se pasa a \scanf, y el valor introducido por el usuario se carga utilizando la instrucción LW (\q{Load Word}) y luego se pasa a \printf.}
...
\ES{IDA muestra la disposición de la pila de la siguiente manera:}
