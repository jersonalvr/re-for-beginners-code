...
\ES{Esta obra está bajo la licencia Creative Commons «Atribución-NoComercial-SinDerivadas» 3.0 Unported. 
Para consultar una copia de esta licencia, visite} \url{http://creativecommons.org/licenses/by-nc-nd/3.0/}.

\RU{Версия этого текста}\EN{Text version}\ES{Versión de este texto} ({\large \today}).
...
\ES{La versión más reciente de este texto (y la edición en ruso) está disponible en }%
...
\ES{La versión en formato A4 también está disponible allí.}
\else
\RU{Версия для электронных читалок так же доступна на сайте.}
\EN{An e-book reader version is also available.}
\ES{La versión para lectores electrónicos también está disponible en el sitio.}
\fi
...
\ES{Existe también una versión LITE (versión introductoria abreviada), pensada para quienes quieren una introducción rápida a los conceptos básicos de la ingeniería inversa}:
...
\ES{También puedes seguirme en Twitter para enterarte de las actualizaciones de este texto:
\TT{@yurichev}\footnote{\href{http://go.yurichev.com/17021}{twitter.com/yurichev}}
o suscribirte a la lista de correo}%
\footnote{\href{http://go.yurichev.com/17020}{yurichev.com}}.

\RU{Обложка нарисована Андреем Нечаевским}\EN{The cover was made by Andy Nechaevsky}\ES{La portada fue realizada por Andy Nechaevsky}: \href{http://go.yurichev.com/17023}{facebook}.
