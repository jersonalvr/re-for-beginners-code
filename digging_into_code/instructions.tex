...
one can try to check each one manually with a debugger.}\PTBRph{}\ES{se puede intentar verificar cada una manualmente con un depurador.}\PLph{}\\
\\
...
operand\EMDASH{}obviously, they do not suit us):}\PTBRph{}\ES{operando\EMDASH{}obviamente, no nos sirven):}\PLph{}\\

\begin{lstlisting}
cat EXCEL.lst | grep fdiv | grep -v dbl_ > EXCEL.fdiv
\end{lstlisting}

\RU{\dots то окажется, что их всего 144.}\EN{\dots then we see that there are 144 of them.}\PTBRph{}\ES{\dots entonces vemos que hay 144 de ellas.}\PLph{}\\
\\
...
\EN{Also as a practical joke, we can modify it on the fly:}\PTBRph{}\ES{También como broma práctica, podemos modificarlo sobre la marcha:}\PLph{}\\
