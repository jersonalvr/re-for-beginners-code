...
\EN{Widely popular examples include DOS/4GW (the DOOM video game was compiled for it), Phar Lap, PMODE.}\ES{Ejemplos ampliamente populares incluyen DOS/4GW (el videojuego DOOM fue compilado para él), Phar Lap, PMODE.}\PTBRph{}\PLph{} \\
\\
