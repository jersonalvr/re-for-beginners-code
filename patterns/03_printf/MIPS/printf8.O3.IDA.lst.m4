...
; _EN(`pass 5th argument in stack')_RU(`передать 5-й аргумент в стеке')_ES(`pasar el 5to argumento en la pila'):
.text:00000014                 li      $v0, 4
.text:00000018                 sw      $v0, 0x38+var_28($sp)
; _EN(`pass 6th argument in stack')_RU(`передать 6-й аргумент в стеке')_ES(`pasar el 6to argumento en la pila'):
.text:0000001C                 li      $v0, 5
.text:00000020                 sw      $v0, 0x38+var_24($sp)
; _EN(`pass 7th argument in stack')_RU(`передать 7-й аргумент в стеке')_ES(`pasar el 7mo argumento en la pila'):
.text:00000024                 li      $v0, 6
.text:00000028                 sw      $v0, 0x38+var_20($sp)
; _EN(`pass 8th argument in stack')_RU(`передать 8-й аргумент в стеке')_ES(`pasar el 8vo argumento en la pila'):
.text:0000002C                 li      $v0, 7
.text:00000030                 lw      $t9, (printf & 0xFFFF)($gp)
.text:00000034                 sw      $v0, 0x38+var_1C($sp)
; _EN(`prepare 1st argument in')_RU(`готовить 1-й аргумент в')_ES(`preparar el 1er argumento en') $a0: 
.text:00000038                 lui     $a0, ($LC0 >> 16)  # "a=%d; b=%d; c=%d; d=%d; e=%d; f=%d; g=%"...
; _EN(`pass 9th argument in stack')_RU(`передать 9-й аргумент в стеке')_ES(`pasar el 9no argumento en la pila'):
.text:0000003C                 li      $v0, 8
.text:00000040                 sw      $v0, 0x38+var_18($sp)
; _EN(`pass 1st argument in')_RU(`передать 1-й аргумент в')_ES(`pasar el 1er argumento en') $a1:
.text:00000044                 la      $a0, ($LC0 & 0xFFFF)  # "a=%d; b=%d; c=%d; d=%d; e=%d; f=%d; g=%"...
; _EN(`pass 2nd argument in')_RU(`передать 2-й аргумент в')_ES(`pasar el 2do argumento en') $a1:
.text:00000048                 li      $a1, 1
; _EN(`pass 3rd argument in')_RU(`передать 3-й аргумент в')_ES(`pasar el 3er argumento en') $a2:
.text:0000004C                 li      $a2, 2
; _EN(`call')_RU(`вызов')_ES(`llamada a') printf():
.text:00000050                 jalr    $t9
; _EN(`pass 4th argument in')_RU(`передать 4-й аргумент в')_ES(`pasar el 4to argumento en') $a3 (branch delay slot):
