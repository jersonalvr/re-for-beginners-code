...
It modifies the value addressed by the pointer and then \printf prints the modified value.}\ES{Modifica el valor al que apunta el puntero y luego \printf imprime el valor modificado.}\PTBRph{}\PLph{}\\
\\
