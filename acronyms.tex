\part*{\RU{Список принятых сокращений}\EN{Acronyms used}\ES{Lista de acrónimos usados}\PTBRph{}\PLph{}}
\addcontentsline{toc}{part}{\RU{Список принятых сокращений}\EN{Acronyms used}\ES{Lista de acrónimos usados}\PTBRph{}\PLph{}}
\begin{acronym}
\RU{
...
\ES{
	...
	\acro{OOP}{Programación orientada a objetos}
	\acro{PL}{Lenguaje de programación}
	\acro{PRNG}{Generador de números pseudoaleatorios}
	\acro{ROM}{Memoria de solo lectura}
	\acro{ALU}{Unidad aritmético-lógica}
}
\PTBR{
	\acro{OS}{\PTBRph{}}
	\acro{FAQ}{\PTBRph{}}
...
\acro{RA}{\RU{Адрес возврата}\EN{Return Address}\PTBRph{}\ES{Dirección de retorno}\PLph{}}
...
\acro{IDA}{
	...
	\ES{Desensamblador y depurador interactivo desarrollado por \href{https://hex-rays.com/}{Hex-Rays}}
	\PTBRph{}
	\PLph{}
}
...
\acro{AKA}{Also Known As\RU{ (Также известный как)}\ES{ (También conocido como)}\PTBRph{}\PLph{}}
...
\acro{ELF}{\RU{Формат исполняемых файлов, использующийся в Linux и некоторых других *NIX}
	\EN{Executable file format widely used in *NIX systems including Linux}\ES{Formato de archivo ejecutable usado ampliamente en sistemas *NIX, incluido Linux}\PTBRph{}\PLph{}}
...
\acro{PID}{\RU{ID программы/процесса}\EN{Program/process ID}\ES{ID de programa/proceso}\PTBRph{}\PLph{}}
