...
while blocking other threads and interrupts.}\ES{Las secciones críticas en cualquier \ac{OS} son muy importantes en un entorno multihilo, principalmente para garantizar que solo un hilo pueda acceder a algunos datos en un momento dado, bloqueando otros hilos e interrupciones.}\PTBRph{}\PLph{} \\
\\
