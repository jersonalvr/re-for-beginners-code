...
\EN{As an exercise, you can try to compile this function and to understand, how it works.}\ES{Como ejercicio, puedes compilar esta función y entender cómo funciona.}\PTBRph{}\PLph{}\\
\\
