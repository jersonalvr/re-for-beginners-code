...
\myref{sec:x86_instructions}.
\fi
}\PTBRph{}\ES{Los compiladores modernos no emiten las instrucciones \TT{LOOP} y \TT{RCL}. Por otro lado, estas instrucciones son bien conocidas por los codificadores que les gusta programar directamente en lenguaje ensamblador. Si las ves, se puede decir que hay una alta probabilidad de que este fragmento de código haya sido escrito a mano. \ifx\LITE\undefined Tales instrucciones están marcadas como (M) en la lista de instrucciones en este apéndice: \myref{sec:x86_instructions}. \fi}\PLph{}\\
\\
