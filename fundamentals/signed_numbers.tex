...
and unsigned (\JA, \JB) operations.}\PTBRph{}\ES{La diferencia entre números con y sin signo es que si representamos \TT{0xFFFFFFFE} y \TT{0x0000002} como sin signo, entonces el primer número (4294967294) es mayor que el segundo (2). Si los representamos ambos como con signo, el primero es -2, que es menor que el segundo (2). Esa es la razón por la que los saltos condicionales (\myref{sec:Jcc}) están presentes tanto para comparaciones con signo (ej. \JG, \JL) como sin signo (\JA, \JB).}\PLph{} \\
\\
